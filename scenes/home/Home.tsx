...
export default function Home() {
  return (
    <div className="flex flex-col items-center p-4 mx-auto w-full">
      <div className="bg-blue-600 sm:h-96 w-full md:w-3/4 rounded-md p-8 md:p-14 flex flex-col justify-between">
        ...
        <div className="flex flex-col justify-between items-center">
          <button className="bg-black text-white rounded-md px-4 py-2 mx-auto block mt-4">
            Link Up!
          </button>
          <div className="flex flex-row justify-center items-center mt-4">
            ...
            <Link href="find" className="text-black font-bold border border-black rounded-md px-4 py-2 mx-auto block ml-2">
              Find your Look
            </Link>
          </div>
        </div>
